...
<body bgcolor="#ECF1F5">
	...
	<nav class="container-fluid" style="background: #2B3245;color:white;">
		<?php 
			$A_C1 = ""; $A_C2="disabled"; $A_C3=""; $A_C4=""; $A_C5="";
			include 'nav.php'; 
		?>
	</nav>
	...
	<div class="container" style="margin-top: 20px;">
		<div class="row">
			...
			<div class="col-4 col-md-2">
				<a href="functions/setStyle.php"><button class="btn btn-secondary btn-size-100">Cambiar vista</button></a>
			</div>
		</div>
	</div>

	<?php if ($_SESSION['estilo']==1): ?>
				...
				<div class="shadow <?php echo $style; ?>" id="box-user-<?php echo $row['id_usuario']; ?>">
					<div class="row">
						<div class="col-12 col-md-1">
							<h5 style="margin-top: 15px;"># <?php echo $i; ?></h5>
						</div>
						<div class="col-4 col-md-1">
							<img class="rounded-circle" src="../<?php echo $row['foto'] ?>" alt="Perfil" width="100%">
						</div>
						<div class="col-8 col-md-2">
							<h6 style="margin-top: 2.5%;"><?php echo $row['nombre']." ".$row['apellido']; ?></h6>
						</div>
						<div class="col-8 col-md-2">
							<p style="margin-top: 2.5%;margin-bottom: 0;"><b>Reg:</b></p>
							<?php echo $row['fecha']; ?>
						</div>
						<div class="col-8 col-md-1">
							<p style="margin-top: 15px;margin-bottom: 0;"><b>Edad: </b>00</p>
						</div>
						<div class="col-8 col-md-1">
							<p style="margin-top: 15px;margin-bottom: 0;"><b>Bc: </b><?php echo $row['becado']; ?></p>
						</div>
						<div class="col-8 col-md-2">
							<p id="roleAsign<?php echo $row['id_usuario']; ?>" style="margin-top: 15px;margin-bottom: 0;"><b>Role: </b><?php 
								$r = $row['role'];
