	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body center-text">
	        <a id="btn-FB" href="" target="_blank"><button class="btn btn-outline-primary">
	        	<img src="imgs/icons/fb.png" width="25px"> Facebook
	        </button></a>
	        <a id="btn-TW" href="" target="_blank"><button class="btn btn-outline-primary">
	        	<img src="imgs/icons/twitter.png" width="25px"> Twitter
	        </button></a>
	        <a id="btn-G" href="" target="_blank"><button class="btn btn-outline-primary">
			...
			<div class="col-md-12">
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    ...
				    <li class="breadcrumb-item" aria-current="page">Historias</li>
				  </ol>
				</nav>
				<h1>Historias - Testimonios</h1>
			</div>
		</div>
...
<?php 
	...
	$SANotes = $con -> query("SELECT * FROM publicacion WHERE categoria='historia' AND estado='1'");
